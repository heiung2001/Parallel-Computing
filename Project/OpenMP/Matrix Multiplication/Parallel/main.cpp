...
void ParallelResultCalculation(double* pMat, double* pVec, double* pRes, int Size);
void TestResult(double* pMat, double* pVec, double* pRes, int Size);
...
void TestResult(double* pMat, double* pVec, double* pRes, int Size)
{
    ...
    SerialResultCalculation(pMat, pVec, pSerialResult, Size);
    for (i = 0; i < Size; i++) {
